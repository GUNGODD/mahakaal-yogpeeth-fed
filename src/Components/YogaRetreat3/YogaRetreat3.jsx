...
import { Retreat1, Retreat10, Retreat11, Retreat12, Retreat13, Retreat14, Retreat3, Retreat6, Retreat7, Retreat8, RetreatCarousel } from '../../utils'
...
const YogaRetreat3 = () => {
  return (
    <div>
        ...
        <PriceGrid heading={"Normal rooms included in this package"} inr={"6000rs"} usd={"125$"} sub1={"Indian"} sub2={"Foreigners"}/>
