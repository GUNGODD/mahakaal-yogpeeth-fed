  ...
  return (
    <>
      <div className="flex flex-wrap justify-between">
        <div className="p-4 w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
          <div
            className="relative"
...
export const OnePagerSection = () => {
  return (
    <section>
      <div className="py-24 px-8 mx-auto max-w-7xl md:px-12 lg:px-32">
        <div>
          ...
          <div className="grid gap-x-2 gap-y-12 mt-12 md:grid-cols-2">
            <div>
              <div className="overflow-hidden p-2 rounded-3xl border">
                <img
            ...
            >
              <div className="flex gap-x-4 items-center text-xs">
                ...
                <a
                  ...
                  className="relative z-10 py-1.5 px-3 font-medium text-gray-600 bg-gray-50 rounded-full hover:bg-gray-100"
                >
                  {post.category.title}
                </a>
              </div>
...
const TypewriterHeading = () => {
  return (
    <section className="py-24 px-8 mx-auto max-w-7xl md:px-12 lg:px-32">
      <div>
        <h1 className="text-4xl font-semibold tracking-tighter text-center text-gray-900 lg:text-5xl text-balance">
          Yoga School in Rishikesh - Mahakaal{" "}
          <span className="text-black bg-indigo-300 rounded-lg border shadow shadow-gray-100">
            <Typewriter
              words={["Yogpeeth"]}
              loop={0}
              cursor
        ...
        <h1 className="mt-12 text-4xl font-semibold tracking-tighter text-center text-gray-900 lg:text-5xl text-balance">
